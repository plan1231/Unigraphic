...
class TFT_MIPI : public TFT
{
 ...
 public:
    /**
     * @brief Create a BUS display interface
     * 
     * @param displayproto BUS_8
     * @param buspins 
     * @param CS 
     * @param reset 
     * @param DC 
     ...
     * @param name 
     */
    TFT_MIPI(proto_t displayproto,PinName* buspins, PinName CS, PinName reset, PinName DC, PinName WR, PinName RD, const char* name, const int LCDSIZE_X = 320, const int LCDSIZE_Y=480);
